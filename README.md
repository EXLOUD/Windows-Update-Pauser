...
<p align="center">
  <img src="https://custom-icon-badges.demolab.com/badge/Version-v1.3.17-brightgreen?logo=tag&logoColor=white" />
...
This v1.3.17 release introduces **native ARM64 support**, **UCRT runtime builds**, and a **deep registry lockdown** to fully disable Windows Update services, driver updates, and metadata fetching.
...
Download the latest **v1.3.17** release from [GitHub Releases](https://github.com/EXLOUD/Windows-Update-Pauser/releases).
